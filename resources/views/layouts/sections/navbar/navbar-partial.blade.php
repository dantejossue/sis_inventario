  ...
  <ul class="navbar-nav flex-row align-items-center ms-auto">
    ...
    <li class="nav-item navbar-dropdown dropdown-user dropdown">
      ...
      <ul class="dropdown-menu dropdown-menu-end">
          ...
          <a class="dropdown-item" href="javascript:void(0);">
            <div class="d-flex">
              ...
              <div class="flex-grow-1">
                <!-- VITAL: Mostramos el nombre dinámico del usuario logueado -->
                <h6 class="mb-0">{{ Auth::user()->nombre_usuario }}</h6>
        ...
        <li>
          <!-- Al hacer clic, prevenimos la acción por defecto y enviamos el formulario oculto -->
          ...
          <!-- Formulario oculto que envía el POST y el Token de Seguridad -->
